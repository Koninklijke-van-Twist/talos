...
const TRANSLATIONS = [
    'nl' => [
        ...
        'dept_access.button_title' => 'Afdelingstoegang beheren',
        'dept_access.panel_title' => 'Afdelingstoegang',
        'dept_access.close' => 'Sluiten',
        'dept_access.email_label' => 'Gebruiker toevoegen',
        'dept_access.email_placeholder' => 'zoek op naam of e-mail...',
        'dept_access.add' => 'Toevoegen',
        'dept_access.users_title' => 'Gebruikers',
        'dept_access.empty_users' => 'Nog geen gebruikers met afdelingstoegang.',
        'dept_access.modal_title' => 'Afdelingen voor %s',
        'dept_access.save' => 'Opslaan',
        'dept_access.cancel' => 'Annuleren',
        'dept_access.save_failed' => 'Opslaan mislukt.',
        'dept_access.load_failed' => 'Laden mislukt.',
        'dept_access.no_departments' => 'Geen afdelingen beschikbaar.',
        'status.open' => 'Open',
    ...
    'en' => [
        ...
        'dept_access.button_title' => 'Manage department access',
        'dept_access.panel_title' => 'Department access',
        'dept_access.close' => 'Close',
        'dept_access.email_label' => 'Add user',
        'dept_access.email_placeholder' => 'search by name or e-mail...',
        'dept_access.add' => 'Add',
        'dept_access.users_title' => 'Users',
        'dept_access.empty_users' => 'No users with department access yet.',
        'dept_access.modal_title' => 'Departments for %s',
        'dept_access.save' => 'Save',
        'dept_access.cancel' => 'Cancel',
        'dept_access.save_failed' => 'Save failed.',
        'dept_access.load_failed' => 'Load failed.',
        'dept_access.no_departments' => 'No departments available.',
        'status.open' => 'Open',
    ...
    'de' => [
        ...
        'dept_access.button_title' => 'Abteilungzugriff verwalten',
        'dept_access.panel_title' => 'Abteilungzugriff',
        'dept_access.close' => 'Schliessen',
        'dept_access.email_label' => 'Benutzer hinzufuegen',
        'dept_access.email_placeholder' => 'suche nach Name oder E-Mail...',
        'dept_access.add' => 'Hinzufuegen',
        'dept_access.users_title' => 'Benutzer',
        'dept_access.empty_users' => 'Noch keine Benutzer mit Abteilungzugriff.',
        'dept_access.modal_title' => 'Abteilungen fuer %s',
        'dept_access.save' => 'Speichern',
        'dept_access.cancel' => 'Abbrechen',
        'dept_access.save_failed' => 'Speichern fehlgeschlagen.',
        'dept_access.load_failed' => 'Laden fehlgeschlagen.',
        'dept_access.no_departments' => 'Keine Abteilungen verfuegbar.',
        'status.open' => 'Offen',
    ...
    'fr' => [
        ...
        'dept_access.button_title' => 'Gerer l acces aux departements',
        'dept_access.panel_title' => 'Acces aux departements',
        'dept_access.close' => 'Fermer',
        'dept_access.email_label' => 'Ajouter un utilisateur',
        'dept_access.email_placeholder' => 'rechercher par nom ou e-mail...',
        'dept_access.add' => 'Ajouter',
        'dept_access.users_title' => 'Utilisateurs',
        'dept_access.empty_users' => 'Aucun utilisateur avec acces departement.',
        'dept_access.modal_title' => 'Departements pour %s',
        'dept_access.save' => 'Enregistrer',
        'dept_access.cancel' => 'Annuler',
        'dept_access.save_failed' => 'Echec de l enregistrement.',
        'dept_access.load_failed' => 'Echec du chargement.',
        'dept_access.no_departments' => 'Aucun departement disponible.',
        'status.open' => 'Ouvert',
